...
function createNavItems() {
  for (section of sections) { // for every section in section
    itemName = section.getAttribute("data-nav"); // variable have the sections data nav value 
    itemLink = section.getAttribute("id"); // variable have the sections id value
    listItem = document.createElement("li"); // create li element
    listItem.textContent = itemName;
    listItem.innerHTML = `<a class="menu__link" href="#" data-nav="${itemLink}">${itemName}</a>`; // giving the new a element the same attributes
